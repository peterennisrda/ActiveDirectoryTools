...
30            VerifySetup
40        Else
50            Debug.Print , "varDebug IS NOT missing so a variant parameter is passed to aeDocumentTheDatabase"
60            Debug.Print , "DEBUGGING TURNED ON"
70            VerifySetup ''' "varDebug"
80        End If

90        ListOrCloseAllOpenQueries
...
100       Debug.Print "aeDocumentTheDatabase", "aegitSetup = " & aegitSetup, "aegitFrontEndApp = " & aegitFrontEndApp
          'Stop
          
          Dim strTheSourceLocation As String
110       If aegitSourceFolder = "default" Then
120           strTheSourceLocation = aegitType.SourceFolder
130       ElseIf aegitFrontEndApp Then
140           strTheSourceLocation = aestrSourceLocation
150       ElseIf Not aegitFrontEndApp Then
160           strTheSourceLocation = aestrSourceLocationBe
170       End If

180       aeBeginLogging "aeDocumentTheDatabase"
190       If aegitSetup Then
200           KillAllFiles aestrSourceLocation            '= aegitType.SourceFolder
210           KillAllFiles aestrXMLLocation               '= aegitType.XMLFolder
220           KillAllFiles aestrXMLDataLocation           '= aegitType.XMLDataFolder
230       ElseIf aegitFrontEndApp Then
240           KillAllFiles aestrSourceLocation
250           KillAllFiles aestrXMLLocation
260           KillAllFiles aestrXMLDataLocation
270       ElseIf Not aegitFrontEndApp Then
280           KillAllFiles aestrSourceLocationBe
290           KillAllFiles aestrXMLLocationBe
300           KillAllFiles aestrXMLDataLocationBe
310       End If
320       aePrintLog "Timing for KillAllFiles"
330       aeEndLogging "aeDocumentTheDatabase"

340       If Not IsMissing(varDebug) Then
350           DocumentTheContainer "Forms", "frm", varDebug
360           DocumentTheContainer "Reports", "rpt", varDebug
370           DocumentTheContainer "Scripts", "mac", varDebug
380           DocumentTheContainer "Modules", "bas", varDebug
390       Else
400           aeBeginLogging "aeDocumentTheDatabase"
410           DocumentTheContainer "Forms", "frm"
420           aePrintLog "Timing for DocumentTheContainer Forms"
430           aeEndLogging "aeDocumentTheDatabase"

440           aeBeginLogging "aeDocumentTheDatabase"
450           DocumentTheContainer "Reports", "rpt"
460           aePrintLog "Timing for DocumentTheContainer Reports"
470           aeEndLogging "aeDocumentTheDatabase"

480           aeBeginLogging "aeDocumentTheDatabase"
490           DocumentTheContainer "Scripts", "mac"
500           aePrintLog "Timing for DocumentTheContainer Macros"
510           aeEndLogging "aeDocumentTheDatabase"

520           aeBeginLogging "aeDocumentTheDatabase"
530           DocumentTheContainer "Modules", "bas"
540           aePrintLog "Timing for DocumentTheContainer Modules"
550           aeEndLogging "aeDocumentTheDatabase"
560       End If

          ' =============
          '    QUERIES
          ' =============
570       aeBeginLogging "aeDocumentTheDatabase"
580       i = 0
590       If Not IsMissing(varDebug) Then Debug.Print "QUERIES"

          ' Delete all TEMP queries ...
600       For Each qdf In CurrentDb.QueryDefs
610           strqdfName = qdf.Name
620           If Left$(strqdfName, 1) = "~" Then
630               CurrentDb.QueryDefs.Delete strqdfName
640               CurrentDb.QueryDefs.Refresh
650           End If
660       Next qdf
670       If Not IsMissing(varDebug) Then Debug.Print , "Temp queries deleted"

          ' This will output each query specification to a file and convert UTF-16 to regular text
680       For Each qdf In CurrentDb.QueryDefs
690           strqdfName = qdf.Name
700           If Not IsMissing(varDebug) Then Debug.Print , strqdfName
710           If Not (Left$(strqdfName, 4) = "MSys" Or Left$(strqdfName, 4) = "~sq_" _
                  Or Left$(strqdfName, 4) = "~TMP" _
                  Or Left$(strqdfName, 3) = "zzz") Then
720               i = i + 1
730               Application.SaveAsText acQuery, strqdfName, strTheSourceLocation & strqdfName & ".qry"
                  ' Convert UTF-16 to txt - fix for Access 2013+
740               If aeReadWriteStream(strTheSourceLocation & strqdfName & ".qry") = True Then
750                   KillProperly (strTheSourceLocation & strqdfName & ".qry")
760                   Name strTheSourceLocation & strqdfName & ".qry" & ".clean.txt" As strTheSourceLocation & strqdfName & ".qry"
770               End If
780           End If
790       Next qdf

800       If Not IsMissing(varDebug) Then
810           If i = 1 Then
820               Debug.Print , "1 Query EXPORTED!"
830           Else
840               Debug.Print , i & " Queries EXPORTED!"
850           End If
              
860           If CurrentDb.QueryDefs.count = 1 Then
870               Debug.Print , "1 Query EXISTING!"
880           Else
890               Debug.Print , CurrentDb.QueryDefs.count & " Queries EXISTING!"
900           End If
910       End If
920       aePrintLog "Timing for DocumentTheContainer Queries"
930       aeEndLogging "aeDocumentTheDatabase"
          'Stop

          ' =============
          '    OUTPUTS
          ' =============
940       If Not IsMissing(varDebug) Then
950           OutputListOfContainers aeAppListCnt, varDebug
960           OutputListOfAccessApplicationOptions varDebug
970           If aegitExport.ExportCBID Then
980               OutputListOfCommandBarIDs strTheSourceLocation & aeAppCmbrIds, varDebug
990               SortTheFile strTheSourceLocation & aeAppCmbrIds, strTheSourceLocation & aeAppCmbrIds & ".sort"
1000              KillProperly (strTheSourceLocation & aeAppCmbrIds)
1010          End If
1020          If aegitExport.ExportNoODBCTablesInfo Then
1030              OutputListOfTables aegitExport.ExportNoODBCTablesInfo, varDebug
1040          Else
1050              OutputListOfTables Not (aegitExport.ExportNoODBCTablesInfo), varDebug
1060          End If
1070          OutputTableDataMacros varDebug
1080          OutputPrinterInfo "Debug"
1090          If aeExists("Tables", "aetlkpStates", varDebug) Then
1100              OutputTableDataAsFormattedText "aetlkpStates", varDebug
1110          End If
1120          If aeExists("Tables", "USysRibbons", varDebug) Then
1130              OutputTableDataAsFormattedText "USysRibbons", varDebug
1140          End If
1150          OutputCatalogUserCreatedObjects varDebug
1160          OutputListOfAllHiddenQueries varDebug
1170          OutputListOfForms varDebug
1180          OutputListOfMacros varDebug
1190          OutputListOfModules varDebug
1200          OutputListOfReports varDebug
1210          OutputBuiltInPropertiesText varDebug
1220          OutputAllContainerProperties varDebug
1230          OutputTableProperties varDebug
1240          aeGetReferences varDebug
1250          aeDocumentTables varDebug
1260          aeDocumentRelations varDebug
1270          aeDocumentTablesXML varDebug
1280      Else
1290          OutputListOfContainers aeAppListCnt
1300          OutputListOfAccessApplicationOptions
1310          If aegitExport.ExportCBID Then
1320              OutputListOfCommandBarIDs strTheSourceLocation & aeAppCmbrIds
                  'Debug.Print , "strTheSourceLocation = " & strTheSourceLocation
                  'Debug.Print , "aeAppCmbrIds = " & aeAppCmbrIds
                  'Stop
1330              SortTheFile strTheSourceLocation & aeAppCmbrIds, strTheSourceLocation & aeAppCmbrIds & ".sort"
1340              KillProperly (strTheSourceLocation & aeAppCmbrIds)
1350          End If
1360          If aegitExport.ExportNoODBCTablesInfo Then
1370              OutputListOfTables aegitExport.ExportNoODBCTablesInfo, varDebug
1380          Else
1390              OutputListOfTables Not (aegitExport.ExportNoODBCTablesInfo), varDebug
1400          End If
1410          OutputTableDataMacros
1420          OutputPrinterInfo
1430          If aeExists("Tables", "aetlkpStates") Then
1440              OutputTableDataAsFormattedText "aetlkpStates"
1450          End If
1460          If aeExists("Tables", "USysRibbons") Then
1470              OutputTableDataAsFormattedText "USysRibbons"
1480          End If
1490          OutputCatalogUserCreatedObjects
1500          OutputListOfAllHiddenQueries
1510          OutputListOfForms
1520          OutputListOfMacros
1530          OutputListOfModules
1540          OutputListOfReports
1550          OutputBuiltInPropertiesText
1560          OutputAllContainerProperties
1570          OutputTableProperties
1580          aeGetReferences
1590          aeDocumentTables
1600          aeDocumentRelations
1610          aeDocumentTablesXML
1620      End If

1630      OutputListOfApplicationProperties
1640      OutputQueriesSqlText
1650      OutputFieldLookupControlTypeList
1660      If aegitExport.ExportCreateDbScript Then
1670          OutputTheSchemaFile
1680          OutputTheSqlFile strTheSourceLocation & aeSchemaFile, strTheSourceLocation & aeSchemaFile & ".sql"
1690          OutputTheSqlOnlyFile strTheSourceLocation & aeSchemaFile & ".sql", strTheSourceLocation & aeSchemaFile & ".sql" & ".only"
1700          KillProperly (strTheSourceLocation & aeSchemaFile & ".sql")
1710          GenerateLovefieldSchema strTheSourceLocation & aeSchemaFile & ".sql" & ".only", strTheSourceLocation & aeLoveSchema
1720      End If
1730      OutputListOfIndexes strTheSourceLocation & aeIndexLists
          'Stop

1740      If aegitExport.ExportQAT Then
1750          If Not IsMissing(varDebug) Then
1760              OutputTheQAT aeAppListQAT, varDebug
1770          Else
1780              OutputTheQAT aeAppListQAT
1790          End If
1800      End If

1810      aeDocumentTheDatabase = True

PROC_EXIT:
1820      Set qdf = Nothing
1830      Set doc = Nothing
1840      Set cnt = Nothing
          'aeEndLogging "aeDocumentTheDatabase"
1850      Exit Function

PROC_ERR:
1860      MsgBox "Erl=" & Erl & " Error " & Err.Number & " (" & Err.Description & ") in procedure aeDocumentTheDatabase of Class aegit_expClass", vbCritical, "ERROR"
...
1870      aeDocumentTheDatabase = False
1880      Resume PROC_EXIT
